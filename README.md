...
* Analyze profit concentration using Pareto principle

* Detect margin volatility and pricing inefficiencies
...
* $93K+ total profit, with 99.87% profit from top 10 products

* Top 5 Wonka products contribute ~95% of total profit

* Identified low-margin products (as low as 7.69%) needing optimization
...
* Profit Concentration (Pareto Chart)
...
* Enables data-driven product portfolio decisions
